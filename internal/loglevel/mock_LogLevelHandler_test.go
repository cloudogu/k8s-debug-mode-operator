...
func (_m *MockLogLevelHandler) GetLogLevel(ctx context.Context, element interface{}) (LogLevel, error) {
	...
	var r0 LogLevel
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, interface{}) (LogLevel, error)); ok {
		return rf(ctx, element)
	}
	if rf, ok := ret.Get(0).(func(context.Context, interface{}) LogLevel); ok {
		r0 = rf(ctx, element)
	} else {
...
func (_c *MockLogLevelHandler_GetLogLevel_Call) Return(_a0 LogLevel, _a1 error) *MockLogLevelHandler_GetLogLevel_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *MockLogLevelHandler_GetLogLevel_Call) RunAndReturn(run func(context.Context, interface{}) (LogLevel, error)) *MockLogLevelHandler_GetLogLevel_Call {
	_c.Call.Return(run)
	return _c
}
...
func (_c *MockLogLevelHandler_SetLogLevel_Call) Run(run func(ctx context.Context, element interface{}, targetLogLevel LogLevel)) *MockLogLevelHandler_SetLogLevel_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(context.Context), args[1].(interface{}), args[2].(LogLevel))
	})
	return _c
}
...
func (_c *MockLogLevelHandler_SetLogLevel_Call) RunAndReturn(run func(context.Context, interface{}, LogLevel) error) *MockLogLevelHandler_SetLogLevel_Call {
	_c.Call.Return(run)
	return _c
}
