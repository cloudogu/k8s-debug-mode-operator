...
repositoryName = "k8s-debug-mode-operator"
        ...
        try {
            ...
            stage('Deploy crd') {
                    withCredentials([[$class: 'UsernamePasswordMultiBinding', credentialsId: 'harborhelmchartpush', usernameVariable: 'HARBOR_USERNAME', passwordVariable: 'HARBOR_PASSWORD']]) {
                        ...
                        k3d.helm("install k8s-debug-mode-operator-crd oci://${registryUrl}/${registryNamespace}/k8s-debug-mode-operator-crd --version ${debugModeCrdVersion}")
                }
            }
